...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messaging = (function () {
	  ...
	  _createClass(Messaging, null, [{
	    ...
	    value: function addMessageHTML(name, message) {
	      var row = (0, _jquery2['default'])("<div class='row'>").appendTo(MESSAGES_ELEMENT);
	      (0, _jquery2['default'])("<div class='user'>").text(name).appendTo(row);
	      (0, _jquery2['default'])("<div class='message'>").text(message).appendTo(row);
	  ...
	  _createClass(Room, [{
	    ...
	    value: function setCreatedAtAndStartTimers() {
	      ...
	      createdAtFB.on('value', function (snapshot) {
	        ...
	        if (!_this5.createdAt) {
	          createdAtFB.set(_firebase2['default'].ServerValue.TIMESTAMP);
	    ...
	    value: function sendMessage(userId, message) {
	      this.messagesFirebase.push({ userId: userId, message: message, created_at: _firebase2['default'].ServerValue.TIMESTAMP });
	    }
	...
	var MESSAGE_INPUT = (0, _jquery2['default'])('#messageInput');
	var USER_ID_INPUT = (0, _jquery2['default'])('#userId');
	var MESSAGES_ELEMENT = (0, _jquery2['default'])('#messages');
