...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsUrlGenerator = __webpack_require__(161);

	var _componentsUrlGenerator2 = _interopRequireDefault(_componentsUrlGenerator);

	var $roomName = (0, _jquery2['default'])('#url-generator #room-name');
	var $urlResult = (0, _jquery2['default'])('#url-generator #url-result');
	var $submitButton = (0, _jquery2['default'])('#url-generator button[name="submit"]');

	var generateUrl = function generateUrl(roomName) {
	  return 'https://samlau95.github.io/pg-chat-room?' + ('room=' + roomName + '&user_id=${e://Field/CHATROOM%20ID}');
	};

	var outputResult = function outputResult(url) {
	  $urlResult.html(url);
	};

	(0, _jquery2['default'])(function () {
	  $submitButton.click(function () {
	    return outputResult(generateUrl($roomName.val()));
	  });
	});
	...
	var AdminApp = (function (_React$Component) {
	  ...
	  function AdminApp() {
	    ...
	    _get(Object.getPrototypeOf(AdminApp.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(AdminApp, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(_componentsUrlGenerator2['default'], null);
	    }
	  }]);
	...
	(0, _jquery2['default'])(function () {
	  _reactDom2['default'].render(_react2['default'].createElement(AdminApp, null), document.getElementById('url-generator-two'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlGenerator = (function (_React$Component) {
	  ...
	  function UrlGenerator(props) {
	    ...
	    _get(Object.getPrototypeOf(UrlGenerator.prototype), "constructor", this).call(this, props);
	    this.state = {};
	  }
	  ...
	  _createClass(UrlGenerator, [{
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement("input", { type: "text", id: "room-name", placeholder: "Room name" }),
	        _react2["default"].createElement(
	          "button",
	          { name: "submit" },
	          "Submit"
